  ...
  return (
    <section className="bg-stone-950 py-24 lg:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        {/* Rotating image */}
        <div className="relative rounded-2xl overflow-hidden aspect-[16/9] max-w-4xl mx-auto ring-1 ring-white/5 shadow-2xl">
          <Image
            key={current}
          ...
          <div className="absolute bottom-5 right-5 flex gap-2">
            {renderings.map((_, i) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all duration-300 ${i === current ? 'bg-accent-gold w-5' : 'bg-white/30 hover:bg-white/60'}`}
